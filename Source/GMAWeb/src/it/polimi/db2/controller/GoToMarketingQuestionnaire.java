...
public class GoToMarketingQuestionnaire extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			//Salvo nella sessione l'array di domande, così non devo recuperarlo con un'altra query in GoToStatQuestionnaire.
			request.getSession().setAttribute("QuestionsArray", productQuestions);
		...
		ctx.setVariable("useranswers", null);
		templateEngine.process(path, ctx, response.getWriter());
